...
func (f *fakeRollbackStore) CompleteInvocationAndMarkFree(invID string, status string, exitCode int, responsePayload []byte, logs string, startedAt time.Time, containerID string, shouldMarkFree bool) error {
	return nil
}

func (f *fakeRollbackStore) AcquireFreeContainer(functionID string) (*models.Container, error) {
	return nil, nil
}
...
func (f *fakeRollbackStore) GetContainersByFunction(functionID string) ([]models.Container, error) {
...
func (f *fakeRollbackStore) GetInvocationLogs(functionID string, limit int) ([]models.Invocation, error) {
	return nil, nil
}
...
func (f *fakeRollbackStore) RollbackToVersionWithID(functionName, targetVersion, requestID string) (string, string, error) {
	// Return the version, a default functionID (as string), and any error
	return f.rollbackToPrevious, "func-id-1", f.rollbackToErr
}
...
func (f *fakeRollbackStore) UpdateCleanupStatus(functionID string, requestID string, status, errMsg string) error {
	return nil
}
...
func TestRollbackService_TargetVersionNotFound(t *testing.T) {
	store := &fakeRollbackStore{
		listVersionsResult: []models.Function{
			{ID: "func-id-1", Name: "myfunction", Version: "v1", Status: "active", Image: "myfunction:v1"},
			{ID: "func-id-2", Name: "myfunction", Version: "v2", Status: "inactive", Image: "myfunction:v2"},
		},
	}
	client := &fakeRollbackContainerClient{}
	service := NewRollbackService(store, client)
...
func TestRollbackService_ExplicitVersion(t *testing.T) {
	store := &fakeRollbackStore{
		listVersionsResult: []models.Function{
			{ID: "func-id-1", Name: "myfunction", Version: "v2", Status: "active", CreatedAt: time.Now(), Image: "myfunction:v2"},
			{ID: "func-id-2", Name: "myfunction", Version: "v1", Status: "inactive", CreatedAt: time.Now().Add(-time.Hour), Image: "myfunction:v1"},
		},
		rollbackToPrevious: "v2",
		// After rollback to v1, v1 should be active
		getActiveFnResult: &models.Function{ID: "func-id-2", Name: "myfunction", Version: "v1", Status: "active", Image: "myfunction:v1"},
	}
	client := &fakeRollbackContainerClient{}
	service := NewRollbackService(store, client)
...
func TestRollbackService_ImplicitVersion(t *testing.T) {
	store := &fakeRollbackStore{
		listVersionsResult: []models.Function{
			{ID: "func-id-1", Name: "myfunction", Version: "v3", Status: "active", CreatedAt: time.Now(), Image: "myfunction:v3"},
			{ID: "func-id-2", Name: "myfunction", Version: "v2", Status: "inactive", CreatedAt: time.Now().Add(-time.Hour), Image: "myfunction:v2"},
			{ID: "func-id-3", Name: "myfunction", Version: "v1", Status: "inactive", CreatedAt: time.Now().Add(-2 * time.Hour), Image: "myfunction:v1"},
		},
		rollbackToPrevious: "v3",
		// After rollback, v2 should be active
		getActiveFnResult: &models.Function{ID: "func-id-2", Name: "myfunction", Version: "v2", Status: "active", Image: "myfunction:v2"},
	}
	client := &fakeRollbackContainerClient{}
	service := NewRollbackService(store, client)
...
func TestRollbackService_RollbackError(t *testing.T) {
	store := &fakeRollbackStore{
		listVersionsResult: []models.Function{
			{ID: "func-id-1", Name: "myfunction", Version: "v2", Status: "active", Image: "myfunction:v2"},
			{ID: "func-id-2", Name: "myfunction", Version: "v1", Status: "inactive", Image: "myfunction:v1"},
		},
...
func TestRollbackService_ContainerCleanupAsync(t *testing.T) {
	store := &fakeRollbackStore{
		// After rollback: v1 is active, v2 is inactive
		listVersionsResult: []models.Function{
			{ID: "func-id-2", Name: "myfunction", Version: "v1", Status: "active", CreatedAt: time.Now().Add(-time.Hour), Image: "myfunction:v1"},
			{ID: "func-id-1", Name: "myfunction", Version: "v2", Status: "inactive", CreatedAt: time.Now(), Image: "myfunction:v2"},
		},
		rollbackToPrevious: "v2",
		getActiveFnResult:  &models.Function{ID: "func-id-2", Name: "myfunction", Version: "v1", Status: "active", Image: "myfunction:v1"},
		getContainersResult: []models.Container{
			{ID: "c1", FunctionID: "func-id-1", Status: "free", CreatedAt: time.Now().Add(-time.Hour)},
			{ID: "c2", FunctionID: "func-id-1", Status: "busy", CreatedAt: time.Now().Add(-30 * time.Minute)},
		},
	}
	client := &fakeRollbackContainerClient{}
	service := NewRollbackService(store, client)
...
func TestRollbackService_ContainerCleanupSkipsUnhealthyContainers(t *testing.T) {
	store := &fakeRollbackStore{
		...
		rollbackToPrevious: "v2",
		getContainersResult: []models.Container{
			{ID: "c1", FunctionID: "func-id-2", Status: "terminated", CreatedAt: time.Now().Add(-time.Hour)},
			{ID: "c2", FunctionID: "func-id-2", Status: "failed", CreatedAt: time.Now().Add(-30 * time.Minute)},
		},
	}
	client := &fakeRollbackContainerClient{}
	service := NewRollbackService(store, client)
